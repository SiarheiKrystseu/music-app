package com.krystseu.microservices.storageservice.firebase;
...
public class HeaderAuthorizationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
        ...
        log.debug("Incoming request URI: {}", httpRequest.getRequestURI());
        ...
        if (authHeader != null && authHeader.startsWith("Bearer ")) {
            ...
            try {
                ...
                log.info("Claims from Firebase Token: {}", decodedToken.getClaims());
